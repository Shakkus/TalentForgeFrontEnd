        ...
        <div className='landing'> 
            ...
            <div className="footer">
                ...
                <div className="logo-redes">
                    <img src="src/Components/LandingPage/imgs/opcion4.jpg" alt="" srcset="" />
                    <div className="logo-redes">
                        <img src={logo1} alt="" />
                        <div className="redes">
                ...
                <div className="about">
                    <h3>About Us</h3>
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nostrum eligendi illo, ducimus accusantium quidem </p>
                </div>
            </div>
        </div>
    )
